...
switch nargin
    ...
    case 4
        ...
        dataPathSavedData = varargin{3}; % name of the file where to save information
           % about the group selection
        dataPathSavedDataAbs = varargin{4}; %  first part of the name of the file where to save data
        %%% default values
...
while n < dimSim
    ...
    switch extChoiseDataset
        case 0 % mat
            save([dataPathSavedDataAbs nStr1 '_' nStr2 '.mat'], 'absData', 'dimPl', 'k');
        case 1 % csv and mat
            %%% csv
